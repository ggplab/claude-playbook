...
〈클로드가 다 해줌〉 9장을 완주하면 나오는 결과물입니다. **따라 하다 막혔을 때 "제대로 나온 모양"을 확인하는 용도**입니다.

파일을 그대로 내려받아 쓰기보다, 9장 본문의 프롬프트로 직접 만들어 보시길 권합니다. 클로드는 같은 요청에도 표현이 조금씩 다를 수 있고, 기준은 겉모습이 아니라 **동작**입니다.
