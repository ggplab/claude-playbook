...
> 스크립트 원본 파일: [Chap7_statusline-command.sh](Chap7_statusline-command.sh)
...
[Chap7_statusline-command.sh](Chap7_statusline-command.sh)의 내용 전체를 `~/.claude/statusline-command.sh` 경로에 파일로 저장하세요.
